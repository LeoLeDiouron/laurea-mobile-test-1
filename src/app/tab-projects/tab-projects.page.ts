...
export class TabProjectsPage {
  ...
  constructor() {
    ...
    this.projects = [
      {'status': 'school', 'title': 'CV application', 'description': 'Application that presents myself in Ionic4'},
      {'status': 'personnal', 'title': 'Poker game online', 'description': 'Poker game web app in NodeJs and PhaserJS'},
      {'status': 'school', 'title': 'Images viewer', 'description': 'Android application that displays photos on internet from keywords'},
    ];
  }
}
